...
QT_MOC_LITERAL(1, 7, 1), // "S"
QT_MOC_LITERAL(2, 9, 0), // ""
QT_MOC_LITERAL(3, 10, 4), // "flag"
QT_MOC_LITERAL(4, 15, 12) // "SelectSignal"

    },
    "select\0S\0\0flag\0SelectSignal"
};
...
void select::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->S((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->SelectSignal(); break;
        default: ;
        }
        ...
        {
            typedef void (select::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&select::S)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject select::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_select.data,
      qt_meta_data_select,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
