namespace РГР
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.количествокгDataGridViewTextBoxColumn = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.типПродуктаDataGridViewTextBoxColumn = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.рГРDataSetBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.рГРDataSet = new РГР.РГРDataSet();
			...
			this.блюдаTableAdapter = new РГР.РГРDataSetTableAdapters.БлюдаTableAdapter();
			this.продуктыTableAdapter = new РГР.РГРDataSetTableAdapters.ПродуктыTableAdapter();
			((System.ComponentModel.ISupportInitialize)(this.dataGridView1)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.dataGridView2)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.продуктыBindingSource)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.рГРDataSetBindingSource)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.рГРDataSet)).BeginInit();
			...
			this.dataGridView1.Location = new System.Drawing.Point(249, 25);
			this.dataGridView1.Name = "dataGridView1";
			this.dataGridView1.Size = new System.Drawing.Size(451, 176);
            ...
            this.количествокгDataGridViewTextBoxColumn,
            this.типПродуктаDataGridViewTextBoxColumn});
			this.dataGridView2.DataSource = this.продуктыBindingSource;
			this.dataGridView2.Location = new System.Drawing.Point(249, 208);
			...
			this.продуктыBindingSource.DataSource = this.рГРDataSetBindingSource;
			// 
			// comboBox1
			// 
			...
			this.comboBox2.Location = new System.Drawing.Point(13, 152);
			...
			this.comboBox3.Location = new System.Drawing.Point(13, 180);
			...
			this.label1.Text = "Количество посетителей:";
			// 
			// textBox1
			// 
			...
			// textBox2
			// 
			this.textBox2.Location = new System.Drawing.Point(143, 290);
			...
			// textBox3
			// 
			this.textBox3.Location = new System.Drawing.Point(143, 312);
			...
			// textBox4
			// 
			this.textBox4.Location = new System.Drawing.Point(143, 335);
			...
			this.label5.Text = "Содержащийся продукт";
			// 
			// button4
			// 
			this.button4.Location = new System.Drawing.Point(11, 80);
			this.button4.Name = "button4";
			this.button4.Size = new System.Drawing.Size(198, 23);
			this.button4.TabIndex = 19;
			this.button4.Text = "Поиск по критерию";
			this.button4.UseVisualStyleBackColor = true;
			this.button4.Click += new System.EventHandler(this.button4_Click);
			// 
			// button5
			// 
			this.button5.Location = new System.Drawing.Point(92, 51);
			this.button5.Name = "button5";
			this.button5.Size = new System.Drawing.Size(117, 23);
			this.button5.TabIndex = 20;
			this.button5.Text = "Полная база";
			...
			this.label6.Text = "Составление меню";
			// 
			...
			// 
			// количествокгDataGridViewTextBoxColumn
			// 
			this.количествокгDataGridViewTextBoxColumn.DataPropertyName = "Количество(кг)";
			this.количествокгDataGridViewTextBoxColumn.HeaderText = "Количество(кг)";
			this.количествокгDataGridViewTextBoxColumn.Name = "количествокгDataGridViewTextBoxColumn";
			// 
			// типПродуктаDataGridViewTextBoxColumn
			// 
			this.типПродуктаDataGridViewTextBoxColumn.DataPropertyName = "Тип продукта";
			this.типПродуктаDataGridViewTextBoxColumn.HeaderText = "Тип продукта";
			this.типПродуктаDataGridViewTextBoxColumn.Name = "типПродуктаDataGridViewTextBoxColumn";
			// 
			// рГРDataSetBindingSource
			// 
			this.рГРDataSetBindingSource.DataSource = this.рГРDataSet;
			this.рГРDataSetBindingSource.Position = 0;
			// 
			// рГРDataSet
			// 
			this.рГРDataSet.DataSetName = "РГРDataSet";
			this.рГРDataSet.SchemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
			// 
			...
			this.блюдаBindingSource.DataSource = this.рГРDataSet;
			// 
			// блюдаTableAdapter
			// 
			...
			((System.ComponentModel.ISupportInitialize)(this.рГРDataSetBindingSource)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.рГРDataSet)).EndInit();
		...
		private РГРDataSet рГРDataSet;
		private System.Windows.Forms.BindingSource блюдаBindingSource;
		private РГРDataSetTableAdapters.БлюдаTableAdapter блюдаTableAdapter;
		...
		private System.Windows.Forms.BindingSource рГРDataSetBindingSource;
		private System.Windows.Forms.BindingSource продуктыBindingSource;
		private РГРDataSetTableAdapters.ПродуктыTableAdapter продуктыTableAdapter;
		...
		private System.Windows.Forms.DataGridViewTextBoxColumn количествокгDataGridViewTextBoxColumn;
		private System.Windows.Forms.DataGridViewTextBoxColumn типПродуктаDataGridViewTextBoxColumn;
